...
%%%%%%%%%
\title{Enabling run-time state migration between same-purpose applications of different vendors}
...
\researchgroup{Database and Information Systems}
\supervisor{
Prof. Dr. Gregor Engels

Dr. Enes Yigitbas
}
\advisor{Dennis Wolters}
\submissiondate{\today{}}
