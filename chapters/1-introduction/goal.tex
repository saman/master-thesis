The goal of the thesis is to enable run-time state migration between applications serving the same purpose and are developed for different platforms and by different vendors. 
